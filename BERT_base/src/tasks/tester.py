...
from .train_funcs import load_state, evaluate_results
...
def test(args, test_loader):
    ...
    ckp_path = './model/best_model_param.pkl'
    ...
    logger.info("Using all test data...")
    _ = evaluate_results(net, test_loader, pad_id, cuda, args, mode="base_test")
